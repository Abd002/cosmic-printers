...
pub(super) async fn delete_printer(name: &str) -> BackendResult<()> {
...
pub(super) async fn set_printer_default(name: &str) -> BackendResult<()> {
...
pub(super) async fn set_printer_enabled(name: &str, enabled: bool) -> BackendResult<()> {
...
pub(super) async fn set_printer_info(name: &str, info: &str) -> BackendResult<()> {
...
pub(super) async fn set_printer_location(name: &str, location: &str) -> BackendResult<()> {
...
pub(super) async fn set_printer_shared(name: &str, shared: bool) -> BackendResult<()> {
...
async fn with_proxy<'a, F, Fut>(operation: &'static str, call: F) -> BackendResult<()>
where
    ...
    Fut: Future<Output = zbus::Result<String>>,
{
    let connection = Connection::system()
        .await
        .map_err(|error| BackendError::zbus(operation, error))?;
